...
#ROOT_DIR = "/data/25fall_nowcasting/lgj/PreDiff-25fall"
ROOT_DIR = "/home/user01/personal_file/lgj/PreDiff-25fall"

# ---- Experiments ----
default_exps_dir = os.path.join(ROOT_DIR, "experiments-1121-train")
