...
def get_parser():
    ...
    parser.add_argument('--save', default='1027_train', type=str)
    parser.add_argument('--nodes', default=1, type=int,
                        help="Number of nodes in DDP training.")
    parser.add_argument('--gpus', default=1, type=int,
                        help="Number of GPUS per node in DDP training.")
    parser.add_argument('--cfg', default='/data/25fall_nowcasting/yrz/PreDiff-25fall/scripts/prediff/sevirlr/prediff_sevirlr_v1.yaml', type=str)
